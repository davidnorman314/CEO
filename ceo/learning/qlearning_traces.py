...
from ceo.learning.learning_base import EpisodeInfo, QTableLearningBase
    ...
    def train(self, params: dict, do_log: bool):
        ...
        for episode in range(1, self._train_episodes + 1):
            ...
            while True:
                ...
                for update_tuple in eligibility_traces:
            ...
            if False and episode > 0 and episode % 5000 == 0:  # noqa: SIM223
                ...
                for info in episode_infos:
                    ...
                    format_str = (
                        ...
                        "visit {visit_count:#w#} alpha {alpha:.3e}"
                    )
